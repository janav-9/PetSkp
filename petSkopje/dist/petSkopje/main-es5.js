...
var AddPetDialogComponent = /** @class */ (function () {
    function AddPetDialogComponent(data, afs, auth) {
        this.afs = afs;
        this.auth = auth;
        this.pet = {
            Breed: '',
    ...
    AddPetDialogComponent.prototype.ngOnInit = function () {
    };
    AddPetDialogComponent.prototype.savePet = function () {
    ...
    AddPetDialogComponent.ctorParameters = function () { return [
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.updateCurrentUser = function (notifPet, notifProd, vetUid) {
        var userRef = this.afs.doc("users/" + this.userUid);
        var data = {
            uid: this.userUid,
        };
...
var CardComponent = /** @class */ (function () {
    ...
    CardComponent.prototype.setVet = function () {
...
var DialogDetailsComponent = /** @class */ (function () {
    function DialogDetailsComponent(httpClient, data) {
    ...
    DialogDetailsComponent.prototype.getPlaces = function () {
        var self = this;
        var url;
    ...
    DialogDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        this.getPlaces().subscribe(function (x) { _this.place = x.result; _this.loading = false; });
    };
    DialogDetailsComponent.prototype.getimg = function (imgRef) {
        return "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=" + imgRef + "&key=" + this.apiKey;
    };
    DialogDetailsComponent.ctorParameters = function () { return [
...
var MypetComponent = /** @class */ (function () {
    function MypetComponent(afs, swPush, service, dialog, auth) {
        this.afs = afs;
        this.swPush = swPush;
    ...
    MypetComponent.prototype.updateUser = function (np, npr) {
    ...
    MypetComponent.prototype.getPets = function () {
        var _this = this;
        this.myArray = [];
        this.afs.collection("pets", function (ref) { return ref.where("Userid", "==", _this.auth.userUid); }).get()
            .subscribe(function (ss) {
            ss.docs.forEach(function (doc) {
                var pet = doc.data();
                pet.Uid = doc.id;
                _this.myArray.push(pet);
            });
        });
    };
    MypetComponent.prototype.openDialog = function () {
        var _this = this;
        this.dialog.open(_add_pet_dialog_add_pet_dialog_component__WEBPACK_IMPORTED_MODULE_4__["AddPetDialogComponent"]).afterClosed()
            .subscribe(function () { return _this.getPets(); });
    };
    MypetComponent.prototype.deletePet = function (uid) {
        var _this = this;
        if (confirm("Дали сте сигурни дека сакате да го избришете миленичето?")) {
            this.afs.collection("pets").doc(uid).delete().then(function () {
                _this.ngOnInit();
    ...
    MypetComponent.prototype.getAge = function (birthdate) {
        var timeDiff = Math.abs(Date.now() - birthdate.getTime());
        var age = Math.floor((timeDiff / (1000 * 3600 * 24)) / 365.25);
        return age;
    };
    MypetComponent.prototype.onResize = function (event) {
        this.cols = (event.target.innerWidth <= 1200) ? 1 : 2;
    };
    MypetComponent.prototype.sendNotification = function () {
        var _this = this;
        if (this.swPush.isEnabled && this.notifPet) {
            this.swPush.requestSubscription({
                ...
                .then(function (sub) {
                _this.service.postSubscription(sub).subscribe();
            })
                .catch(console.error);
        }
    };
    MypetComponent.ctorParameters = function () { return [
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(breakpointObserver, auth) {
...
var NotificationService = /** @class */ (function () {
    ...
    NotificationService.prototype.postSubscription = function (sub) {
    ...
    NotificationService.prototype.handlError = function (error) {
...
var ShopsComponent = /** @class */ (function () {
    function ShopsComponent(httpClient, changeDetectorRef, afs) {
        this.httpClient = httpClient;
        this.changeDetectorRef = changeDetectorRef;
        this.afs = afs;
        this.apiKey = _app_config__WEBPACK_IMPORTED_MODULE_3__["AppConfig"].settings.apiKey;
    }
    ShopsComponent.prototype.getPlaces = function (token) {
        var self = this;
        var url;
    ...
    ShopsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getPlaces().subscribe(function (x) {
            _this.places = x.results;
            _this.token = x.next_page_token;
            _this.filteredPlaces = x.results;
            _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](_this.filteredPlaces);
            _this.changeDetectorRef.detectChanges();
            _this.dataSource.paginator = _this.paginator;
            _this.obs = _this.dataSource.connect();
        });
        this.getproducts();
    };
    ShopsComponent.prototype.getproducts = function () {
        var _this = this;
        this.myArray = [];
    ...
    ShopsComponent.prototype.getData = function () {
        var _this = this;
        this.getPlaces(this.token).subscribe(function (x) { _this.places = x.results; _this.token = x.next_page_token; });
        this.filteredPlaces = this.places;
        return true;
    };
    ShopsComponent.prototype.applyFilter = function (filterValue) {
        if (filterValue == undefined || filterValue == null) {
            this.filteredPlaces = this.places;
        }
        else
            this.filteredPlaces = this.places.filter(function (v) { return v.name.includes(filterValue) || v.formatted_address.includes(filterValue); });
    ...
    ShopsComponent.prototype.showMore = function () {
        var _this = this;
        this.getPlaces(this.token).subscribe(function (x) {
            _this.places = x.results;
            _this.token = x.next_page_token;
            _this.filteredPlaces = _this.filteredPlaces.concat(x.results);
            _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](_this.filteredPlaces);
            _this.changeDetectorRef.detectChanges();
            _this.dataSource.paginator = _this.paginator;
            _this.obs = _this.dataSource.connect();
    ...
    ShopsComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
var VetsComponent = /** @class */ (function () {
    function VetsComponent(httpClient, changeDetectorRef, auth) {
        this.httpClient = httpClient;
        this.changeDetectorRef = changeDetectorRef;
        this.auth = auth;
        this.apiKey = _app_config__WEBPACK_IMPORTED_MODULE_3__["AppConfig"].settings.apiKey;
    ...
    VetsComponent.prototype.getPlaces = function (token) {
        var self = this;
        var url;
        if (token != null || token != undefined) {
    ...
    VetsComponent.prototype.showMore = function () {
        var _this = this;
        this.getPlaces(this.token).subscribe(function (x) {
            _this.places = x.results;
            _this.token = x.next_page_token;
    ...
    VetsComponent.prototype.applyFilter = function (filterValue) {
        if (filterValue == undefined || filterValue == null) {
            this.filteredPlaces = this.places;
        }
        else
    ...
    VetsComponent.prototype.getCurrentLocation = function () {
        var _this = this;
    ...
    VetsComponent.prototype.getMatVet = function () {
        var _this = this;
        var user;
        this.auth.user$.subscribe(function (x) {
            user = x;
            _this.getVet(user.vetUid).subscribe(function (x) { _this.vet = x.result; _this.showLikeBtn = false; }, function () { return false; });
        });
    };
    VetsComponent.prototype.getVet = function (vetUid) {
        var self = this;
        var url;
        url = "https://maps.googleapis.com/maps/api/place/details/json?place_id=" + vetUid + "&key=" + this.apiKey + "&language=mk";
        return self.httpClient.get(url);
    };
    VetsComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
        { type: _auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] }
    ]; };
